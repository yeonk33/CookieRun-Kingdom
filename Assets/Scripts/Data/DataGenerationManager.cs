...
public class DataGenerationManager
{
	...
	//private const string _userScriptPath = "Assets/Scripts/Data/User/UserId.cs"; // 스크립트로 만들 스크립트
	...
	private static string ParseUserCSV(string arg)
	{
		...
		return JsonUtility.ToJson(new UserArrayWrapper { users = fullList }, true); // json 데이터 return
	}
